    ...
    <body>
        <div id="form" name="form">
            ...
            <form name="form1" id="form1" method="POST" action="Update">
                ...
                <p><input onclick="Clicked(this);" class="submitbutton" type="submit" name="action" value="Delete"/></p>
                <p><input onclick="Clicked(this);" class="submitbutton" type="submit" name="action" value="Add/Change"/></p>
